                ...
                <div class="card-body">
                    <form id="createPost">
                        ...
                        <div class="col mb-3">
                            ...
                            <textarea name="description" id="description" class="mb-3"></textarea>
                        ...
                        <div class="mb-3 mt-5">
                            <button type="button" onclick="post.save()" class="btn btn-primary submit-lg">Lưu</button>
                        </div>
                    </form>
                </div>
            </div>
...
@section('afterScript')
    ...
    <script src="{{ asset('admin/js/posts/create.js') }}"></script>
@endsection
