        ...
        <div class="col-xl">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-baseline">
                    <h5>TẠO GÓI THI CÔNG THÔ VÀ NHÂN CÔNG</h5>
                    <a href="{{ route('admin.accounting.attr.contruction') }}" class="btn btn-warning">Trở về</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form id="createContruction">
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="text" name="value" class="form-control value  col-4"
